 ...
 */
public class ResourceException extends IdentityException {
    ...
    public ResourceException(String errorCode, String message, Throwable throwable) {
    ...
    public String getErrorDescription() {
        ...
        if (StringUtils.isEmpty(errorDescription)) {
            //TODO define error codes for ResourceRegistration
